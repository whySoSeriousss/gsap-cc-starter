    ...
    boxes.forEach((box) => {
      gsap.to(box, {
        scrollTrigger: {
          ...
          start: "bottom bottom", // Animation starts when the top of the box reaches the center of the viewport
          end: "top 10%", // Animation ends when the bottom of the box reaches the top of the viewport
